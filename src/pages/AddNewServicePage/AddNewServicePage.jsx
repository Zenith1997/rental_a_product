...
const paymentTypes = ["Per Month", "Per Year", "Per Hour"];
...
const AddNewServicePage = () => {
  ...
  const handleSubmit = async () => {
    try {
      const payload = {
        ...formData,
        selling_type: formData.selling_type.join(","), // Convert array to string
  ...
  // Add this new function to handle back button
  const handleBack = () => {
    setCurrentState(1);
    window.scrollTo(0, 0);
  };
  ...
  }).format(formData.scheduleDateTime);
     ...
     <div className='bg-white mt-5 flex justify-center shadow-[0_2px_4px_rgba(0,0,0,0.1)]'>
        ...
        <div className="bg-white w-[70%] flex flex-col px-10 py-5 rounded-xl">
          <div className="flex justify-between items-center mb-10 border-b-2 pb-3">
            ...
            <button className="px-5 py-3 shadow-xl font-semibold border rounded-2xl">
              Save & Exit
            </button>
                    </div>
                          ...
                          Select Dates
                            ...
                            onChange={handleDateRangeChange}
                                                        renderInput={(startProps, endProps) => (
                                                            <React.Fragment>
                                                                <input {...startProps.inputProps} hidden />
                                                                <input {...endProps.inputProps} hidden />
                                                            </React.Fragment>
                                                        )}
                                                    />
                                                </LocalizationProvider>
                ...
                <Box sx={{ width: "100%", marginBottom: 3 }}>
                  ...
                  >
                    <FormControl sx={{ width: "300px" }}>
                        ...
                        sx={{ color: "#4D6079" }}
                        onChange={(e) =>
                          handleInputChange("price_type", e.target.value)
                        }
                                            >
                        ...
                        <h1 className="text-3xl text-[#1A3353] font-medium">
                          ...
                          control={
                            <IOSSwitch
                              ...
                              onChange={(e) =>
                                handleInputChange("schedule_status", !formData.schedule_status)
                              }
                            />
                          }
                        />
          ...
          {currentState == 1 ? (
            ...
            >
              ...
              >
               {!formData.schedule_status? "Add service":"schedule"}
                                </Button>
            </div>
          )}
        </div>
